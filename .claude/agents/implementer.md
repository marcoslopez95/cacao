...
- **NUNCA modificar ni eliminar archivos en `tests/Feature/{Feature}/Acceptance/`** — son el contrato del `tester`
- Si un acceptance test parece incorrecto: reportarlo al `tester` vía el `leader` — nunca editarlo directamente
