...
<template>
    ...
    <div style="display:flex;flex-direction:column;gap:24px;">
        ...
        <div v-if="!grades" style="text-align:center;padding:48px 24px;color:var(--text-muted);">
            <p style="font-size:var(--text-sm);">No tienes inscripción activa en el período actual.</p>
        </div>
            ...
            >
                ...
                <div style="display:flex;flex-wrap:wrap;gap:12px;">
                    ...
                    >
                        ...
                        <div v-if="slot.children.length > 0" style="margin-top:6px;border-top:1px solid var(--color-borde);padding-top:6px;">
                            <div
                                v-for="(child, i) in slot.children"
                                :key="i"
                                style="display:flex;justify-content:space-between;font-size:var(--text-xs);color:var(--text-muted);margin-bottom:2px;"
                            >
